  ...
  const contactInfo = [
    {
      icon: MapPinIcon,
      title: 'Address',
      description: '123 Medical Drive, Health District, City, 10001',
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-500">
                  Have questions about our services or need to schedule an appointment? Reach out to us using the contact form or the information below.
                </p>
      ...
      <div className="bg-gray-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="overflow-hidden rounded-lg shadow-xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.215209057536!2d-73.98784468459366!3d40.74844047932789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259a9b3117469%3A0xd134e199a405a163!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1620000000000!5m2!1sen!2sus"
              width="100%"
              height="450"
              style={{ border: 0 }}
