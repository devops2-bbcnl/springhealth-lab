...
>(({ className, variant = 'default', onClose, dismissible = true, children, ...props }, ref) => {
    ...
    >
      <div className="flex items-center">
        <div className="flex-shrink-0">
          {variant === 'success' && (
            <svg
              className={cn('h-5 w-5', iconVariants[variant])}
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
            ...
            <div className="-mx-1.5 -my-1.5">
              <button
                ...
                className={cn(
                  ...
                  {
                    'bg-blue-50 text-blue-500 hover:bg-blue-100 focus:ring-blue-600': variant === 'default' || variant === 'info',
                    'bg-red-50 text-red-500 hover:bg-red-100 focus:ring-red-600': variant === 'destructive',
